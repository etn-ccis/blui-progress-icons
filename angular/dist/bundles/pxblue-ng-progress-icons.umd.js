(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('color'), require('@angular/common'), require('tslib')) :
    typeof define === 'function' && define.amd ? define('@pxblue/ng-progress-icons', ['exports', '@angular/core', 'color', '@angular/common', 'tslib'], factory) :
    (global = global || self, factory((global.pxblue = global.pxblue || {}, global.pxblue['ng-progress-icons'] = {}), global.ng.core, global.color, global.ng.common, global.tslib));
}(this, (function (exports, core, color, common, tslib) { 'use strict';
    ...
    var PxbProgressIconComponent = /** @class */ (function () {
        ...
        PxbProgressIconComponent.propDecorators = {
            ...
            showPercentLabel: [{ type: core.Input }],
            labelPosition: [{ type: core.Input }],
            color: [{ type: core.Input }],
            labelColor: [{ type: core.Input }],
    ...
    var BatteryComponent = /** @class */ (function (_super) {
        tslib.__extends(BatteryComponent, _super);
    ...
    var HeartComponent = /** @class */ (function (_super) {
        tslib.__extends(HeartComponent, _super);
    ...
    var PieComponent = /** @class */ (function (_super) {
        tslib.__extends(PieComponent, _super);
    ...
    var UpsComponent = /** @class */ (function (_super) {
        tslib.__extends(UpsComponent, _super);
    ...
    exports.PxbProgressIconComponent = PxbProgressIconComponent;
    exports.UpsComponent = UpsComponent;
