...
The publishing script will look at the version in the `icons/package.json` and automatically determine whether to publish an alpha, beta, or latest package.
